...
class AppColors {
  ...
  static const Color YuvaAnubhav = Color(0xFF6A53A1);
  static const Color YAApplogo = Color(0xFF2F3446);
  ...
  static const Color SDev = Color(0xFF0E1319);
  static const Color CVNavTitle = Color(0xFF2A5A4A);
  static const Color CVSelectedNavTitle = Color(0xFFDC7F4A);
  static const Color CVAppLogo = Color(0xFFF5B843);
  ...
  static const Color otp_package = SDev;
  static const Color otpPackageNavTitle = AppColors.black;
  static const Color otpPackageSelectedNavTitle = SDev;
