...
class ImagePath {
  ...
  // static const String ProjectsBg1 = "$imageDir/Hex.webp";
  // static const String ProjectsBg2 = "$imageDir/Soundwave.webp";


  static const String CIRCLE = "$imageDir/circle.png";
  static const String STATUE = "$imageDir/STATUE2.png";
  ...
  // Certifications
  static const String AWS_CP = "$imageDir/AWS CP.png";
  static const String AWS_SAA = "$imageDir/AWS SAA.jpg";
  static const String IIOT = "$imageDir/IIOT.jpg";
  static const String NPTELCC =
      "$imageDir/NPTEL CC.jpg";
  ...
  //
  // // Drop
  static const String CV_COVER = "$projectsDir/SDev/0.jpg";
  ...
  static const String Yuva_Anubhav_Cover =
      "$projectsDir/YuvaAnubhav/7.jpeg";
  static const String Yuva_Anubhav_Screens =
      "$projectsDir/YuvaAnubhav/8.jpeg";
  //
  ...
  //
  // Flutter Catalog
  static const String CURIFY_COVER =
      "$projectsDir/Curify/2.jpeg";
  static const String CURIFY_SCREENS =
      "$projectsDir/Curify/1.jpeg";
  //
