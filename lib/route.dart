...
import 'Screens/ContactPage/Contact.dart';
import 'Screens/CerificationsPage/CertificationPage.dart';
import 'Screens/AboutPage/About_Page.dart';
import 'Screens/ProjectsPage/projects_details_page.dart';
...
class RouteConfiguration {
  ...
  static List<Path> paths = [
    ...
    Path(
      r'^' + ProjectsPage.projectsPageroute,
          (context, matches) => const ProjectsPage(),
    ),
    Path(
